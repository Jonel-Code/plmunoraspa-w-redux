...
import { Button, Card, Form, Header, Image, Ref, Message, Icon } from 'semantic-ui-react';
import plmun_logo from '../../assets/plmun-logo.png';

import { apiAuthenticateAdmin, authenticationClear } from '../../redux/actions/index';
...
class AdminLogin extends Component {
	...
	render () {
		...
		const { id_number, user_name } = this.state.fields;
				...
				<Card centered>
					<Card.Content textAlign='center'>
						<Header as='h2'>
							...
							<Header.Subheader>Amin Login</Header.Subheader>
						</Header>
					</Card.Content>
...
// 							<br />
// 							Plmun Document Request Portal
// 							<Header.Subheader>Admin Login</Header.Subheader>
// 						</Header>
// 					</Card.Content>
// 					<Card.Content textAlign='left'>
// 						<Form>
...
// 								<Icon name='warning sign' />
// 								<Message.Header>Authentication Failed</Message.Header>
// 								<p>Name or Employee ID is incorrect</p>
// 							</Message>
// 						</Form>
// 					</Card.Content>
// 				</Card>
